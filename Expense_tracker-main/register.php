...
$msg="This email  associated with another account";
    ...
    $query=mysqli_query($con, "insert into user(FullName, MobileNumber, Email,  Password) value('$fname', '$mobno', '$email', '$password' )");
    if ($query) {
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" method="post" id="" name="signup" onsubmit="return checkpass();">
