...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; color:#FF0">
           ...
           <!--  dddddddddd -->
 <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">USER &nbsp; <div class="btn-group pull-right">
            ...
            <li class="divider"></li>
               ...
               <li> <a href="user-profile.php"><i class="glyphicon glyphicon-edit">Profile</i></a></li>
                </ul>
            </div>
          </div>
        </nav>         
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a   href="user-profile.php"></i> Dashboard</a>
                    </li>
                   
                      <li  >
                        <?php
                      echo" <li><a  href='index.php'></i>Expense</a></li>";
                      ?>
		...
		echo' <li><a class="active-menu" href="expense_category.php"></i>Create Expense</a></li>';
 ...
 ?>          
                    ...
                    echo'   <li>
                        <a href="#">Expense Summery<span class="fa arrow"></a>
                        
                        
                        
                          <ul class="nav nav-second-level">
             <li>
                                <a href="expense_report.php"></i>Expense Report</a>
                            </li>
                                </ul>
