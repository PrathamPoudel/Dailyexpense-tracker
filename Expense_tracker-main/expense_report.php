...
<body>
 ...
 <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">USER &nbsp; <div class="btn-group pull-right">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                      ...
                      <li  >
                        <?php
                      echo" <li><a  href='index.php'>Expense</a></li>";
                      ?>
		...
		echo' <li><a  href="expense_category.php">Create Expense</a></li>';
 ...
 ?>          
                    ...
                    echo'   <li>
                        <a class="active-menu">Expense Summery<span class="fa arrow"></span></a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Expense Details <cdiv class="pull-right">Search for the result you need</cdiv> 
                        </div>
